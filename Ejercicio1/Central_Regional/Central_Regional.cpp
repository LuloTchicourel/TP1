...
void Central_Regional::add_mid_manager(shared_ptr<Middle_Manager> manager) {mid_managers.push_back(manager);}

void Central_Regional::add_high_manager(shared_ptr<Senior_Manager> manager) {high_managers.push_back(manager);}
